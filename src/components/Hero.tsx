    ...
    <div className="relative h-screen min-h-[600px] flex items-center justify-center bg-primary/10 dark:bg-primary-dark/30">
      ...
      <div className="absolute top-4 right-4">
        <button
          ...
          className="p-2 rounded-full bg-secondary/10 dark:bg-secondary-dark/30"
        >
          {theme === "dark" ? "🌞" : "🌙"}
        </button>
      </div>
      <div className="container mx-auto px-4 z-10">
        <div className="text-center animate-fade-up">
          ...
          <div className="flex items-center justify-center gap-4">
            <button className="bg-secondary text-white px-8 py-3 rounded-full hover:bg-secondary-light transition-colors dark:bg-secondary-dark">
              View Menu
            </button>
            <button className="flex items-center gap-2 bg-primary px-8 py-3 rounded-full hover:bg-primary-dark transition-colors dark:bg-primary-light dark:text-textColor">
